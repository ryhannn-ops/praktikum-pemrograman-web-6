# TODO for Sistem CRUD Backend Implementation

- [x] Update backend/package.json to add "dev" script
- [x] Implement backend/index.js with Express setup, Supabase client, and route registration
- [x] Implement backend/routes/mahasiswa.js with CRUD endpoints for mahasiswa table
